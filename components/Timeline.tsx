...
const experience = [
  ...
  },
  {
    ...
    role: 'Project Manager, System Analyst & UX Lead',
    company: 'Finova',
    type: 'Primary',
    highlights: [
      'Led delivery of enterprise mobile application for Al-Shaheen (Qatari institution)',
      'Managed full project lifecycle: discovery, prototyping, development coordination, and client sign-off',
      'Authored BRDs, system specs, and Figma prototypes that eliminated rework cycles',
      'Coordinated cross-functional teams across Cairo and Doha with zero major escalations',
    ],
    badge: 'PM & Product',
  },
  {
